    ...
    <div className="relative flex flex-col gap-12 pb-12">
      ...
      <section className="relative min-h-[90vh] flex items-center pt-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full text-center">
          <div className="max-w-4xl mx-auto space-y-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-sm font-medium text-text-muted mb-4 animate-in fade-in slide-in-from-bottom-4 duration-700 backdrop-blur-md">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold font-heading tracking-tighter text-white mb-6 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-150 fill-mode-both">
              Learn by doing.<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-purple-400 to-karma">Proof over hierarchy.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-500 fill-mode-both">
              <Link href="/join" className="w-full sm:w-auto">
                <Button size="lg" className="w-full group bg-primary hover:bg-primary/90 text-white shadow-[0_0_20px_rgba(108,92,231,0.3)] transition-all">
              ...
              <Link href="/leads" className="w-full sm:w-auto">
                <Button variant="outline" size="lg" className="w-full border-white/10 hover:bg-white/5 hover:text-white transition-colors bg-white/5">
                  Meet the Leads
                </Button>
              </Link>
              <Link href="/members" className="w-full sm:w-auto">
                <Button variant="outline" size="lg" className="w-full border-white/10 hover:bg-white/5 hover:text-white transition-colors">
                  Members
                </Button>
              </Link>
            </div>
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-700 fill-mode-both text-center md:text-left pt-12">
        <div className="flex flex-col md:flex-row justify-between items-end mb-8 gap-4 px-2">
          <div>
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-white mb-2">Our Tech Domains</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card className="border-white/5 bg-gradient-to-br from-surface to-surface/50 hover:border-primary/50 transition-all hover:-translate-y-1">
            <CardHeader>
          ...
          <Card className="border-white/5 bg-gradient-to-br from-surface to-surface/50 hover:border-karma/50 transition-all hover:-translate-y-1">
            <CardHeader>
          ...
          <Card className="border-white/5 bg-gradient-to-br from-surface to-surface/50 hover:border-blue-500/50 transition-all hover:-translate-y-1">
            <CardHeader>
          ...
          <Card className="border-white/5 bg-gradient-to-br from-surface to-surface/50 hover:border-pink-500/50 transition-all hover:-translate-y-1">
            <CardHeader>
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 relative">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-4 mb-14 relative z-10">
          ...
          <h2 className="text-3xl md:text-5xl font-heading font-bold text-white">Why Join Our Community?</h2>
        ...
        <div className="grid md:grid-cols-3 gap-6 relative z-10">
          <Link href="/events" className="block group">
            <Card className="h-full border-white/5 hover:border-primary/50 transition-colors group-hover:shadow-[0_0_30px_rgba(108,92,231,0.1)] bg-surface/50">
              <CardHeader>
          ...
          <Link href="/projects" className="block group">
            <Card className="h-full border-white/5 hover:border-karma/50 transition-colors group-hover:shadow-[0_0_30px_rgba(245,185,66,0.1)] bg-surface/50">
              <CardHeader>
                <div className="mb-4 group-hover:scale-110 transition-transform group-hover:-translate-y-2 origin-bottom-left">
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 my-8">
        <div className="rounded-[2.5rem] border border-white/10 bg-surface p-8 md:p-14 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden backdrop-blur-xl shadow-2xl">
          ...
          <div className="relative z-10 max-w-2xl text-center md:text-left space-y-4">
            <h3 className="text-3xl md:text-4xl font-heading font-bold text-white leading-tight">Ready to level up your tech journey?</h3>
          ...
          <div className="relative z-10 w-full md:w-auto shrink-0 mt-4 md:mt-0">
            <Link href="/join" className="block">
              <Button size="lg" className="w-full md:w-auto bg-white text-background hover:bg-gray-200 group text-base px-8 py-7 rounded-2xl shadow-[0_0_30px_rgba(255,255,255,0.2)] font-bold">
                Start Building Now
              </Button>
            </Link>
          </div>
