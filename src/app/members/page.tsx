...
const mockMembers: MemberProps[] = [
    {
        id: "1", name: "Adwaith S A", role: "Campus Lead", domains: ["Game Dev", "Cyber Security", "Web Development"],
        karma: 2790, imageUrl: "/leads/adwaithsa.png",
        isCore: true, github: "https://github.com/Adwaith585", linkedin: "https://linkedin.com/in/adwaith-sa"
    },
    {
        id: "2", name: "Abhishek S", role: "Co-Lead", domains: ["Cyber Security", "Generative AI", "Devops"],
        karma: 1627, imageUrl: "/leads/abhishek.jpeg",
        isCore: true, github: "https://github.com/abhishek-007a", linkedin: "https://www.linkedin.com/in/abhishek-sugathan"
    },
    {
        id: "3", name: "Deepthi Mohan", role: "Tech Lead", domains: ["Data Analytics", "Generative AI"],
        karma: 1698, imageUrl: "/leads/deepthi.jpeg",
        isCore: true, github: "https://github.com/DeepM05", linkedin: "https://www.linkedin.com/in/deepthi-mohan-dm/"
    },
    {
        id: "4", name: "Abhin J Gomez", role: "Design Lead", domains: ["IOT And Robotics"],
        karma: 2204, imageUrl: "/leads/abhinjgomez.jpg",
        isCore: true, github: "https://github.com/Abhin147", linkedin: "https://www.linkedin.com/in/abhin-j-gomez/"
    },
    {
        id: "5", name: "Ashwanth A", role: "Creative Lead", domains: ["Cyber Security", "Generative AI"],
        karma: 1426, imageUrl: "/leads/ashwanth.png",
...
export default function MembersPage() {
    ...
    useEffect(() => {
        ...
        const fetchMembers = async () => {
            ...
            // Combine mock members with dynamic ones
            const allMembers = [...mockMembers];
            for (const dm of dynamicMembers) {
                // simple deduplication by ID, though unlikely to overlap
                if (!allMembers.find(m => m.id === dm.id)) {
                    allMembers.push(dm);
                }
            }
